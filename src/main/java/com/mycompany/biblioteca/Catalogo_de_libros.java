 ...
 * @author Ssaid
 */
public class Catalogo_de_libros extends javax.swing.JFrame {

    /**
     * Creates new form Catalogo_de_libros
     */
    public Catalogo_de_libros() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cátalogo de libros");
        ...
        tabla_libros.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Título", "Autor", "Editorial", "Género"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Catalogo_de_libros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Catalogo_de_libros().setVisible(true);
            }
        });
    }
